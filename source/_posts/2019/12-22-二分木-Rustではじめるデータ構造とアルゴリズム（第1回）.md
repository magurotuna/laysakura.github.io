...
- 2019/12/29
    - 二分木の構築コードをシンプルにするために `bin_tree!` マクロを使ったものに差し替え。[Add `bin_tree!` to create a new Node with less letters](https://github.com/laysakura/data-structures-and-algorithms-rs/pull/1) で [@__gfx__](https://twitter.com/__gfx__)氏からPRいただきました😂
