...
また、タイトルとは異なり、必ずしもプロジェクト管理ツールに焦点を絞った発表ではなく、チームビルディングの含んでおりました。
...
掛け持ちがあると、他業務に時間を咲いているときにはプロジェクトメンバーの近くにいられないことがあります。たとえ近くにいても、そのプロジェクトの相談を受けられる余裕がない場合もあるでしょう。
...
やはり開発プロジェクトメンバー間のコミュニケーションが問題になることがあり、
...
一方で自分は、あまりにも人の流動性が失われてしまうとメンバーのスキルの幅を広げたり、良い交流を産む機会を逸してしまう側面もあるかなと考えており、今後実験を重ねて落とし所を探っていきたいと思います。
...
最後になりますが、主催者のヌーラボ様・発表者の方・スタッフの皆様、素敵な会を本当にありがとうございました。
